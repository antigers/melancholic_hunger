...
public class EffectsInInventoryMixin {
	@WrapOperation(
			...
			at=@At(
					value="INVOKE",
					target="Lnet/minecraft/client/gui/Gui;getMobEffectSprite(Lnet/minecraft/core/Holder;)Lnet/minecraft/resources/ResourceLocation;"
			)
	)
	private ResourceLocation melancholic_hunger$getInventoryEffectSprite(Holder<MobEffect> effect, Operation<ResourceLocation> original) {
