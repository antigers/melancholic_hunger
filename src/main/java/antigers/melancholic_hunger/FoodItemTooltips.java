	...
	public static class FoodHealthTooltipComponent implements TooltipComponent
	{
		...
		public void drawItems(TextRenderer textRenderer, int x, int y, int width, int height, DrawContext context)
		{
			...
			for (int i = 0; i < heartsCount - 1; i++) {
				int textureX = x + i * 9;
				context.drawGuiTexture(RenderLayer::getGuiTextured, InGameHud.HeartType.CONTAINER.getTexture(false, false, false), textureX, y, 9, 9);
				context.drawGuiTexture(RenderLayer::getGuiTextured, InGameHud.HeartType.NORMAL.getTexture(false, false, false), textureX, y, 9, 9);
			}
			int textureX = x + (heartsCount - 1) * 9;
			context.drawGuiTexture(RenderLayer::getGuiTextured, InGameHud.HeartType.CONTAINER.getTexture(false, lastHeartIsHalf, false), textureX, y, 9, 9);
			context.drawGuiTexture(RenderLayer::getGuiTextured, InGameHud.HeartType.NORMAL.getTexture(false, lastHeartIsHalf, false), textureX, y, 9, 9);
		}
	}
