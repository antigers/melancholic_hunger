...
public class HUDOverlaysMixin {
	...
	private static void melancholic_hunger$drawComfortOverlay(
			GuiGraphics graphics, RenderPipeline pipeline, ResourceLocation atlas, int x, int y, float u, float v, int width, int height, int textureWidth, int textureHeight, Operation<Void> original
	) {
