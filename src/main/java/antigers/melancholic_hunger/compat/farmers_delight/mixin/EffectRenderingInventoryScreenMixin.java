...
public class EffectRenderingInventoryScreenMixin {
    ...
    private TextureAtlasSprite melancholic_hunger$getInventoryEffectSprite(MobEffectTextureManager instance, MobEffect effect, Operation<TextureAtlasSprite> original) {
