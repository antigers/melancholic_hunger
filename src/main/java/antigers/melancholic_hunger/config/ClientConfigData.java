...
public class ClientConfigData {
    ...
    public ImmutableClientConfigData getImmutable() {
        return new ImmutableClientConfigData(
                hideHungerBar, highlightRegeneratedHearts, regeneratedHeartsOverlayColor, regeneratedHeartsOpacityMin, regeneratedHeartsOpacityMax,
                regeneratedHeartsBlinkingPeriod, highlightRestoredHearts, restoredHeartsOverlayColor, hideExperienceBar, showExperienceInInventory,
